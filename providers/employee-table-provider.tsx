...
interface EmployeeTableContextInterface {
...
export const EmployeeTableContext =
    createContext<EmployeeTableContextInterface | null>(null);

export default function EmployeeTableProvider({
    children,
}: {
